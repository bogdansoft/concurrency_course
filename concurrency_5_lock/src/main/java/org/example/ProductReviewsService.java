 ...
 * After we learned about advanced locks and read-write locks, we told our friend Bob that we now know how to protect shared resources with special
 * locks that keep our application thread-safe and efficient.
 * <p>
 ...
 * <p>
 * He already implemented all the business logic however not knowing which locks to use, he left us blank methods getLockForXXXX()
 * where we can provide his business logic methods with the correct locks.
 * <p>
